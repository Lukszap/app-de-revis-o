      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 mt-1">Entre para continuar seus estudos</p>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 mt-6">
            Não tem uma conta?{' '}
            <a href="/cadastro" className="text-blue-600 hover:text-blue-700 font-medium hover:underline">
              Cadastre-se
            </a>
          </p>
        </div>
